...
> Catalogue of every blog post and podcast/video discovered across Swami ji's sources. ✅ marks entries that have been pulled into [`transcripts.md`](./transcripts.md). ⏳ marks entries discovered but not yet consumed.

**Legend**
- ✅ Consumed into `transcripts.md`
- ⏳ Discovered, pending
- 🔒 Discovered but transcript not retrievable (only title/description captured)
...
## Blogs — os.me (by Om Swami)

| # | Date | Title | Status | URL |
|---|------|-------|--------|-----|

## Podcasts / Talks — Om Swami TV (YouTube)
